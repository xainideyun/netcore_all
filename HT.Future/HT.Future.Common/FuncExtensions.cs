...
namespace HT.Future.Common
{
    ...
    {
        private readonly static JsonSerializerSettings _jsonOption;

        static FuncExtensions()
        {
            _jsonOption = new JsonSerializerSettings 
            { 
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        public static int ToInt(this string str, Encoding encoding = null)
        {
        ...
        {
            return JsonConvert.SerializeObject(obj, _jsonOption);
        }

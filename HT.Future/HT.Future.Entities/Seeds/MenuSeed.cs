...
//                new Menu { Id = 4, Name = "user", Title = "个人中心", ParentId = 2 },
//                new Menu { Id = 5, Name = "order", Title = "订单管理" },
//                new Menu { Id = 6, Name = "sys", Title = "配置", ParentId = 2 },
//                new Menu { Id = 7, Name = "myOrder", Title = "我的订单", ParentId = 5 }
//            );
